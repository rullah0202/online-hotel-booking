...
Route::group(['middleware' =>['admin:admin']], function(){
    ...
    Route::post('admin/profile-update',[AdminProfileController::class,'profile_update'])->name('admin_profile_update');
...
Route::post('admin/reset-password',[AdminLoginController::class,'reset_password'])->name('admin_reset_password');
Route::get('admin/reset-password/{token}/{email}',[AdminLoginController::class,'reset_password_verify'])->name('admin_reset_password_verify');
Route::post('admin/reset-password-submit/{token}/{email}',[AdminLoginController::class,'reset_password_submit'])->name('admin_reset_password_submit');
